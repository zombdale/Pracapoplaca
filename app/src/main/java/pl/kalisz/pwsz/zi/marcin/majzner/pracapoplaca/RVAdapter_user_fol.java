...
public class RVAdapter_user_fol  extends RecyclerView.Adapter<RVAdapter_user_fol.ViewHolder> {
    private String[][] data;
    private CardView cv ;
    ...
    public RVAdapter_user_fol(String[][] data){
        this.data= data;
    ...
    @Override
    public RVAdapter_user_fol.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i){
        ...
        return new RVAdapter_user_fol.ViewHolder(cv);

    }
    @Override
    public void onBindViewHolder(RVAdapter_user_fol.ViewHolder holder, int i){
